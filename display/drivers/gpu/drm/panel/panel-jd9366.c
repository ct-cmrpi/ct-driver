...
static void jd9366_init_sequence(struct jd9366 *ctx)
{
	...
	dcs_write_seq(ctx, 0x01,0xA3);	//VCOM A8 AE ADa9
	//Set VCOM_Reverse
	dcs_write_seq(ctx, 0x03,0x00);
	dcs_write_seq(ctx, 0x04,0xA8);	
	...
	dcs_write_seq(ctx, 0x22,0x7E);     //PA[6]=0, PA[5]=0, PA[4]=0, PA[0]=0 
	...
	dcs_write_seq(ctx, 0x39,0x00);	//RGB_N_EQ1, modify 20140806
	dcs_write_seq(ctx, 0x3A,0x01);	//RGB_N_EQ2, modify 20140806
	dcs_write_seq(ctx, 0x3C,0x78);	//SET EQ3 for TE_H
	dcs_write_seq(ctx, 0x3D,0xFF);	//SET CHGEN_OFF, modify 20140827 
	dcs_write_seq(ctx, 0x3E,0xFF);	//SET CHGEN_OFF, modify 20140827 
	dcs_write_seq(ctx, 0x3F,0xFF);	//SET CHGEN_OFF2, modify 20140827
	...
	dcs_write_seq(ctx, 0x43,0x08);
	dcs_write_seq(ctx, 0x44,0x09);
	dcs_write_seq(ctx, 0x45,0x28);

	//--- power voltage  ----//
	dcs_write_seq(ctx, 0x55,0x0F);	//DCDCM=1111
	//dcs_write_seq(ctx, 0x56,0x01);
	dcs_write_seq(ctx, 0x57,0x89);	//VGH_RT=100, Charge pump Ratio:3*AVDD-VCL
	dcs_write_seq(ctx, 0x58,0x0A);
	dcs_write_seq(ctx, 0x59,0x0A);	//VCL = -2.5V
	dcs_write_seq(ctx, 0x5A,0x28);	//VGH = 15V
	dcs_write_seq(ctx, 0x5B,0x19);	//VGL = -12V



	//--- Gamma  ----//
	dcs_write_seq(ctx, 0x5D,0x7C); // 
	dcs_write_seq(ctx, 0x5E,0x66); //
	dcs_write_seq(ctx, 0x5F,0x56); //
	dcs_write_seq(ctx, 0x60,0x49); //
	dcs_write_seq(ctx, 0x61,0x44); //
	dcs_write_seq(ctx, 0x62,0x34); //
	dcs_write_seq(ctx, 0x63,0x37); //
	dcs_write_seq(ctx, 0x64,0x1F); //
	dcs_write_seq(ctx, 0x65,0x36); //
	dcs_write_seq(ctx, 0x66,0x33); //
	dcs_write_seq(ctx, 0x67,0x32); //
	dcs_write_seq(ctx, 0x68,0x4F); //
	dcs_write_seq(ctx, 0x69,0x3D); //
	dcs_write_seq(ctx, 0x6A,0x43); //
	dcs_write_seq(ctx, 0x6B,0x35); //
	dcs_write_seq(ctx, 0x6C,0x30); //
	dcs_write_seq(ctx, 0x6D,0x24); //
	dcs_write_seq(ctx, 0x6E,0x13); //
	dcs_write_seq(ctx, 0x6F,0x00); //
	dcs_write_seq(ctx, 0x70,0x7C); //
	dcs_write_seq(ctx, 0x71,0x66); //
	dcs_write_seq(ctx, 0x72,0x56); //
	dcs_write_seq(ctx, 0x73,0x49); //
	dcs_write_seq(ctx, 0x74,0x44); //
	dcs_write_seq(ctx, 0x75,0x34); //
	dcs_write_seq(ctx, 0x76,0x37); //
	dcs_write_seq(ctx, 0x77,0x1F); //
	dcs_write_seq(ctx, 0x78,0x36); //
	dcs_write_seq(ctx, 0x79,0x33); //
	dcs_write_seq(ctx, 0x7A,0x32); //
	dcs_write_seq(ctx, 0x7B,0x4F); //
	dcs_write_seq(ctx, 0x7C,0x3D); //
	dcs_write_seq(ctx, 0x7D,0x43); //
	dcs_write_seq(ctx, 0x7E,0x35); //
	dcs_write_seq(ctx, 0x7F,0x30); //
	dcs_write_seq(ctx, 0x80,0x24); //
	dcs_write_seq(ctx, 0x81,0x13); //
	...
	//GIP_L Pin mapping
	dcs_write_seq(ctx, 0x00,0x45);//0x05
	dcs_write_seq(ctx, 0x01,0x45);//0x05  
	dcs_write_seq(ctx, 0x02,0x44);//0x04
	dcs_write_seq(ctx, 0x03,0x44);//0x04
	dcs_write_seq(ctx, 0x04,0x47);//0x07
	dcs_write_seq(ctx, 0x05,0x47);//0x07
	dcs_write_seq(ctx, 0x06,0x46);//0x06
	dcs_write_seq(ctx, 0x07,0x46);//0x06
	dcs_write_seq(ctx, 0x08,0x40);//0x00
	dcs_write_seq(ctx, 0x09,0x1F);//0x1F
	dcs_write_seq(ctx, 0x0A,0x1F);//0x1F
	dcs_write_seq(ctx, 0x0B,0x1F);//0x1F
	dcs_write_seq(ctx, 0x0C,0x1F);//0x1F
	dcs_write_seq(ctx, 0x0D,0x1F);//0x1F
	dcs_write_seq(ctx, 0x0E,0x1F);//0x1F
	dcs_write_seq(ctx, 0x0F,0x41);//0x01
	dcs_write_seq(ctx, 0x10,0x1F);//0x1F
	dcs_write_seq(ctx, 0x11,0x1F);//0x1F
	dcs_write_seq(ctx, 0x12,0x1F);//0x1F
	dcs_write_seq(ctx, 0x13,0x1F);//0x1F
	dcs_write_seq(ctx, 0x14,0x1F);//0x1F
	dcs_write_seq(ctx, 0x15,0x1F);//0x1F

	//GIP_R Pin mapping
	dcs_write_seq(ctx, 0x16,0x45);
	dcs_write_seq(ctx, 0x17,0x45);
	dcs_write_seq(ctx, 0x18,0x44);
	dcs_write_seq(ctx, 0x19,0x44);
	dcs_write_seq(ctx, 0x1A,0x47);
	dcs_write_seq(ctx, 0x1B,0x47);
	dcs_write_seq(ctx, 0x1C,0x46);
	dcs_write_seq(ctx, 0x1D,0x46);
	...
	//GIP Timing  
	dcs_write_seq(ctx, 0x58,0x40);        // TGEQL, Initial porch
	//dcs_write_seq(ctx, 0x59,0x00);
	//dcs_write_seq(ctx, 0x5A,0x00);
	dcs_write_seq(ctx, 0x5B,0x10);       //STV number =4, STV_S0[10:8]
	dcs_write_seq(ctx, 0x5C,0x06);       //STV_S0[7:0] =
	dcs_write_seq(ctx, 0x5D,0x20);//60   //STV_W=4 , STV_S1=0,1h timing
	dcs_write_seq(ctx, 0x5E,0x01);       //STV_S2 =1,1h timing
	dcs_write_seq(ctx, 0x5F,0x02);       //STV_S3 =2,1h timing
	//dcs_write_seq(ctx, 0x60,0x00);     //ETV default
	//dcs_write_seq(ctx, 0x61,0x01);     //ETV default
	//dcs_write_seq(ctx, 0x62,0x02);     //ETV default
	dcs_write_seq(ctx, 0x63,0x62);       //SETV_ON
	dcs_write_seq(ctx, 0x64,0x62);       //SETV_OFF
	//dcs_write_seq(ctx, 0x65,0x00);    //ETV
	//dcs_write_seq(ctx, 0x66,0x00);    //ETV
	dcs_write_seq(ctx, 0x67,0x32);          //CKV0_NUM[3:0]=8, CKV0_W[3:0]=4
	dcs_write_seq(ctx, 0x68,0x08);   //0x06       
	dcs_write_seq(ctx, 0x69,0x62); 
	dcs_write_seq(ctx, 0x6A,0x66); //66 CLK Falling to Source Falling time 3us
	dcs_write_seq(ctx, 0x6B,0x08);  
	dcs_write_seq(ctx, 0x6C,0x00);
	dcs_write_seq(ctx, 0x6D,0x04); //GEQ_GGND1
	dcs_write_seq(ctx, 0x6E,0x04); //GEQ_GGND2
	...
	dcs_write_seq(ctx, 0x98,0x3F);	//From 2E to 3E, LED_ON

	//Page4
	dcs_write_seq(ctx, 0xE0,0x04);  //ESD protect
	...
	//Page0
	dcs_write_seq(ctx, 0xE0,0x00); //Watch dog
	dcs_write_seq(ctx, 0xE6,0x02);
	dcs_write_seq(ctx, 0xE7,0x06);
